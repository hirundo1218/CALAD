...
def get_model(p, pretrain_path=None):
    ...
    if p['backbone'] == 'resnet_ts':
        ...
        from models.resent_time import transformer_ts
        backbone = transformer_ts(**p['res_kwargs'])
    else:
...
def get_val_dataset(p, transform=None, sanomaly=None, to_neighbors_dataset=False,
    ...
    if to_neighbors_dataset:
        ...
        dataset = NeighborsDataset(dataset, transform, N_indices, F_indices, 5)
